...
- :mouse pointer: Измените текст на тот, который будет служить первой строкой вашей истории. Вы также можете изменить расположение текста с ``||game(noclick):снизу||`` на другую область экрана.
