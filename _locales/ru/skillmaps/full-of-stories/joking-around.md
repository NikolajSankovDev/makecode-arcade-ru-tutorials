...
Давайте создадим одну, которой можно поделиться с друзьями.

Создать шутку (или короткую историю) в Arcade почти так же просто, как сделать поздравительную открытку.
Используйте фон и текст, чтобы передать настроение и добавить свой стиль.
...
Перед следующими шагами выберите двухстрочную шутку или придумайте свою.<br/>
Например: «Почему тропические рыбки плавают в солёной воде? Потому что от перца они чихают!»

#### ~ tutorialhint
Вопрос: Почему тропические рыбы плавают в соленой воде?
Ответ: Потому что перец заставляет их чихать!
...
- :paint brush: **Нажмите на пустое поле**, чтобы нарисовать фон, показывающий, где происходит ваша шутка. <br/>
Это океан? Небо? Кухня?
...
Подумайте о героях, лежащих в основе вашей шутки. <br/>
Кем будет читатель
ожидаешь увидеть?  Рыба? Парашютист? Два маффина?

Мы можем добавить эти символы как **спрайты**.
...
У спрайтов есть свойства, которые вы можете использовать и изменять — такие вещи, как масштаб, положение и срок службы, — все это свойства спрайтов.

Наши главные герои тоже будут спрайтами.
...
- :mouse pointer: Создайте идеального персонажа для своей шутки, щелкнув пустое серое поле, чтобы можно было нарисовать что-нибудь в редакторе изображений.
...
- :binoculars: Как это выглядит? Можете ли вы представить, как сложится шутка?
...
Используйте блок контроллера, чтобы позволить читателю контролировать ход шутки.
...
Независимо от того, как вы поделитесь своей шуткой, вы, скорее всего, вызовете больше смеха, если
ваша изюминка представлена ​​отдельно в конце.

---

- :pencil: Напишите свою шутку на бумаге и обведите кульминацию. Обычно это
последняя строка, и это та часть, которая заставляет людей смеяться.

- :mouse pointer: Разбейте остальную часть шутки на небольшие предложения. Сколько текстовых блоков вам понадобится?
...
Есть много способов добавить текст в ваш проект.
...
```
Это лучший способ создать впечатление, будто ваш персонаж говорит. Используйте этот блок, чтобы текст отображался в виде пузыря, исходящего из спрайта.
...
```
Это отличный способ добавить «постоянный» текст в верхнюю, среднюю или нижнюю часть экрана.  Проблема в том, что невозможно удалить метку, если вы хотите ее изменить.
...
game.showLongText("", DialogLayout.Bottom)
```
Оба эти варианта являются фантастическими, и каждый из них исчезнет при повторном нажатии кнопки (A).
...
- :mouse pointer: Экспериментируйте с различными текстовыми блоками, чтобы создать плавную шутку.

Чтобы найти макет, который заставит вас смеяться, может потребоваться несколько попыток, так что не сдавайтесь!
...
**Найдите минутку и посмотрите на свою шутку на игровом экране!**

Это смешно?  Текст перекрывает что-нибудь важное на экране?

---

- :mouse pointer: Если у используемых вами блоков есть параметры, попробуйте разные позиции текста.

Будет ли текст лучше течь где-нибудь еще?
...
Подумайте о том, чтобы добавить звуки или музыку для большего драматизма.
...
Завершите мероприятие на высокой ноте конфетти или экраном, полным улыбок.
...
Теперь у вас есть истеричная шутка, которой вы можете поделиться!


~hint Как мне поделиться своей шуткой?💡
...
Когда вы закончите просматривать свою шутку на экране игры, нажмите **Готово**, чтобы вернуться на главную страницу, где вы сможете поделиться ею.
с семьей и друзьями!
